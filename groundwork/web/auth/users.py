...
if __name__ == "__main__":                       # pragma: no cover
    # The command line lives in users_cli (this module is imported on the
    # login path and stayed under the size cap by moving it) — but the
    # documented entry point is still `-m groundwork.web.auth.users`, which
    # docs/install.md and the app's no-accounts warning both print.
    from .users_cli import main
    main()
